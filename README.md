...
## V13.9.17 - Pagos y Cuentas Pendientes de Proveedores
- Nuevo acceso Compras > Registrar Pago a Proveedores.
- Nuevo acceso Compras > Cuentas Pendientes por Proveedores.
- Consulta por nombre, RUC o número de factura.
- Resumen de saldo pendiente agrupado por proveedor y detalle por documento.
- Pagos parciales o totales contra CxP.
- El pago actualiza el saldo y estado de la cuenta.
- Registra egreso financiero y asiento contable con Cuenta Debe / Cuenta Haber seleccionables.
- Para moneda extranjera utiliza cotización DNIT y conserva diferencia de cambio.


## V13.9.18 - Reestructuración de menús y llamador por consultorio
- Menú principal reorganizado por áreas según la estructura operativa solicitada: Agenda y Recepción, Admisión, Consultorio, Urgencias, Internación, Quirófano, Farmacia/Stock, Ventas/Caja, Compras, Proveedores, Tesorería, Contabilidad, Seguros/Convenios, RR.HH., Auditoría y Reportes/BI.
- Se conserva Laboratorio como módulo independiente con Registro, Ventas al Contado, Seguros y Liquidación LACED.
- Se conserva la impresión térmica de agendamientos existente.
- Médicos incorporan N.º de consultorio configurable.
- El llamador ya no pronuncia el nombre del médico: anuncia al paciente y solicita pasar al consultorio N.º configurado.
- Si el médico no tiene consultorio configurado, el sistema bloquea el llamado y avisa al usuario.


## V13.9.19 - Identidad visual Santa Clara
- Background institucional suministrado por el usuario aplicado al área de trabajo del sistema.
- Fondo con capa blanca translúcida para conservar legibilidad de formularios, grillas y módulos.
- Logo normal Santa Clara suministrado por el usuario aplicado como logo documental.
- PDFs e impresiones que utilizan el helper institucional ahora toman el logo normal.
- Plantillas de impresión existentes que referenciaban el logo anterior fueron actualizadas.
- Se conserva impresión de agendamientos, Laboratorio y estructura operativa V13.9.18.


## V13.9.20 - Reestructuracion general segun estructura sistema nuevo.pdf
...
## V13.9.55 — Libros contables: vista normal, formato rubricado y PDF
- Todos los informes/libros del Centro de Informes Contables incorporan selector **Ver normal** / **Ver formato rubricado**.
